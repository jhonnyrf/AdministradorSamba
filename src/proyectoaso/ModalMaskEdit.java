...
public class ModalMaskEdit extends JDialog {
    ...
    public void OpsionesSeleccionados(String numero){
        String octal=numero.substring(1, 4);
    ...
    public void setU(int u){
       if(u==1){
          u_x.setSelected(true);
        }else if(u==2){
          u_w.setSelected(true);
        }else if(u==3){
          u_x.setSelected(true);
          u_w.setSelected(true);
        }else if(u==4){
          u_r.setSelected(true);
        }else if(u==5){
          u_r.setSelected(true);
          u_x.setSelected(true);
        }else if(u==6){
    ...
    if(g==1){
          g_x.setSelected(true);
        }else if(g==2){
          g_w.setSelected(true);
        }else if(g==3){
          g_x.setSelected(true);
          g_w.setSelected(true);
        }else if(g==4){
          g_r.setSelected(true);
        }else if(g==5){
          g_r.setSelected(true);
          g_x.setSelected(true);
        }else if(g==6){
    ...
    if(o==1){
          o_x.setSelected(true);
        }else if(o==2){
          o_w.setSelected(true);
        }else if(o==3){
          o_x.setSelected(true);
          o_w.setSelected(true);
        }else if(o==4){
          o_r.setSelected(true);
        }else if(o==5){
          o_r.setSelected(true);
          o_x.setSelected(true);
        }else if(o==6){
...
void OpcionesSeleccionadosOtros() {
    ...
    ModalInputMaskEdit modal = new ModalInputMaskEdit(this,octal,item_seleccionado);
