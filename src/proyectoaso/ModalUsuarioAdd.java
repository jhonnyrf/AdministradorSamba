...
public class ModalUsuarioAdd extends javax.swing.JDialog {
    private String itemSeleccionado;
    public ModalUsuarioAdd(JDialog owner,String itemSeleccionado) {
        super(owner,true);
        this.itemSeleccionado=itemSeleccionado;
        initComponents();
        this.setLocationRelativeTo(null);
        this.nombreSeleccionado.setText(itemSeleccionado);
        llenarUsuarios();
    }
    ...
    private void initComponents() {
        ...
        inpurtUsuarios = new javax.swing.JTextField();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(nombreSeleccionado))
                .addGap(31, 31, 31)
                .addComponent(inpurtUsuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void opcionUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcionUsuariosActionPerformed
        ...
        if(!(opcionUsuarios.getSelectedItem().equals("usuarios"))){
          ...
          if(!(inpurtUsuarios.getText().equals(""))){
            String escrito = inpurtUsuarios.getText()+","+seleccionado;
            this.inpurtUsuarios.setText(escrito);
          }else{
            this.inpurtUsuarios.setText(seleccionado);
          }
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
       dispose();
       String valor_seleccionado=inpurtUsuarios.getText();
       String[] res = {itemSeleccionado,valor_seleccionado};
    ...
    private javax.swing.JTextField inpurtUsuarios;
